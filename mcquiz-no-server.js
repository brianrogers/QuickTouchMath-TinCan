...
var mcquiz = function(){
	...
	this.submitAnswer = function(buttonClicked) {
		...
		this.tc_lrs.actor = '{"name" : "'+this.playerName+'","mbox" : "mailto:'+this.playerName+'@quicktouchmath.com" ,"objectType" : "Agent"}';
		
		TCDriver_SendStatement(this.tc_lrs, stmt, function(){
			//do nothing
		});
